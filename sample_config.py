...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py generatestringsession
    EAGLE_STRING = os.environ.get("EAGLE_STRING", None)
    ...
    # set this with required Eagle repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Badhacker98/EAGLEBOT"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "eagleuserbot")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/56557dc496d3032450455.jpg"
    )
    ...
    # Google Drive plugin https://graph.org/G-Drive-guide-for-eagleuserbot-01-01
    ...
    # For updater plugin
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "Bad")
    ...
    VC_REPO = os.environ.get("VC_REPO", "SOON")
