        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**Eaglebot Error report**\n\n"
                        link = "[here](https://t.me/PBX_CHAT)"
            ...
            if pattern is not None:
                ...
                if edited:
                    eagle.add_event_handler(func, events.MessageEdited(**kwargs))
                eagle.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                eagle.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                eagle.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
