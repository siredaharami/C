...
async def safe_check_text(msg):  # sourcery no-metrics
    ...
    phone = str((await eagle.get_entity(eagle.uid)).phone)
    return bool(
        (
            (Config.EAGLE_STRING in msg)
            or (phone[-10:] in msg)
...
async def send_message(
    ...
    *,
    ...
    if safecheck:
        ...
        msg = f"**ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ ꜱᴇɴꜱɪᴛɪᴠᴇ ᴅᴀᴛᴀ ɪ ᴄᴀɴᴛ ꜱᴇɴᴅ ɪᴛ ᴛᴏ ᴘᴜʙʟɪᴄ.& ʀᴇᴘᴏʀᴛᴇᴅ ᴛᴏ ᴀᴅᴍɪɴ ᴏꜰ ᴇᴀɢʟᴇʙᴏᴛ ɢʀᴏᴜᴘ [ᴀᴅᴍɪɴ](https://t.me/PBX_CHAT). & ᴅᴏɴᴛ ᴛʀʏ ᴛᴏ ꜱᴇɴᴅ ᴀɴʏ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴡɪᴛʜᴏᴜᴛ ᴋɴᴏᴡɪɴɢ ᴀɴʏᴛʜɪɴɢ.** ▶️ [ʟᴏɢɢᴇʀ ɢʀᴏᴜᴘ]({msglink})"
        return await client.sendmessage(
            entity=chatid,
            message=msg,
            send_as=send_as,
