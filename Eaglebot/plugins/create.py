...
@eagle.eagle_cmd(
    ...
    info={
        "header": "To create a private group/channel with Eaglebot.",
        ...
        "examples": "{tr}create b EagleUserBot",
    },
)
async def _(event):
    "To create a private group/channel with Eaglebot"
    type_of_group = event.pattern_match.group(1)
    group_name = event.pattern_match.group(2)
    if type_of_group == "c":
        descript = "This is a Test Channel created using EagleUserBot"
    else:
        descript = "This is a Test Group created using EagleUserBot"
    if type_of_group == "g":
        try:
