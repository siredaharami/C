...
@eagle.eagle_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}gs eagleUserBot",
            "{tr}gs -l6 eagleUserBot",
            "{tr}gs -p2 eagleUserBot",
            "{tr}gs -p2 -l7 eagleUserBot",
        ],
    },
)
async def gsearch(q_event):
    "Google search command."
    eagleevent = await eor(q_event, "`searching........`")
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        eagleevent = await eor(event, "Pre Processing Media")
        ...
        if previous_message.media:
            ...
            the_location = google_rs_response.headers.get("Location")
        await eagleevent.edit("Found Google Result. Pouring some soup on it!")
        headers = {
        ...
        try:
            ...
            return await eod(eagleevent, "`Sorry. I am unable to find similar images`")
        end = datetime.now()
...
<i>fetched in {ms} seconds</i>""".format(
        ...
        eagleevent = event
    await eor(eagleevent, OUTPUT_STR, parse_mode="HTML", link_preview=False)
...
async def _(img):
    ...
    if message and message.media:
        ...
        return
    if photo:
        eagleevent = await eor(img, "`Processing...`")
        try:
            image = Image.open(photo)
        except OSError:
            return await eagleevent.edit("`Unsupported , most likely.`")
        name = "okgoogle.png"
        image.save(name, "PNG")
        image.close()
        ...
        if response != 400:
            ...
            return await eagleevent.edit("`Unable to perform reverse search.`")
        ...
        if guess and imgspage:
            ...
            return await eagleevent.edit("`Can't find any kind similar images.`")
