...
from . import eod, eagle, reply_id
...
@eagle.eagle_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [EagleUserBot]<buttonurl:https://github.com/Badhacker98/EAGLEBOT> [support]<buttonurl:https://t.me/PBX_CHAT>",
    },
)
async def _(event):
...
@eagle.eagle_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [EagleBot]<buttonurl:https://github.com/Badhacker98/EAGLEBOT> [support]<buttonurl:https://t.me/PBX_CHAT>",
    },
)
async def _(event):
