...
from . import BOTLOG, BOTLOG_CHATID, eagle, reply_id
...
async def note(e):
    ...
    img = Image.open("Eaglebot/helpers/resources/extras/template.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("Eaglebot/helpers/resources/fonts/assfont.ttf", 30)
    x, y = 150, 140
    lines = text_set(text)
...
async def write_page(event):
    ...
    if not os.path.exists(temp_name):
        urllib.request.urlretrieve(
            f"https://github.com/Badhacker98/EAGLEPLUGIN/blob/Bad/Eaglebot/helpers/resources/extras/{template}.jpg",
            temp_name,
        )
    if not os.path.exists(font_name):
        urllib.request.urlretrieve(
            f"https://github.com/Badhacker98/EAGLEPLUGIN/blob/Bad/Eaglebot/helpers/resources/fonts/{default}.ttf?raw=true",
            font_name,
        )
