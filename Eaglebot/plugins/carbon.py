...
async def carbon_api(event):
    ...
    eagle = await eor(event, "`Carbonizing...\n25%`")
    ...
    await eagle.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await eagle.edit("`Uploading..`")
...
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    EAGLE = await eor(event, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await event.get_reply_message()
    pcode = event.text
    if pcode[5:]:
    ...
    await EAGLE.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = Config.CHROME_BIN
...
async def carbon_api(event):
    ...
    await eagle.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await eagle.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await eagle.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await eagle.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await eagle.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await eagle.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await eagle.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await eagle.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await eagle.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await eagle.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
