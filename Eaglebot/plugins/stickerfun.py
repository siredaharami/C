...
async def sticklet(event):
    ...
    fontsize = 230
    FONT_FILE = await get_font_file(event.client, "@EAGLE_FONTS", font_file_name)
    ...
    image_stream.name = "EagleUserBot.webp"
...
@eagle.eagle_cmd(
    ...
    info={
        ...
        "examples": "{tr}googl eagleuserbot",
    },
)
async def twt(event):
