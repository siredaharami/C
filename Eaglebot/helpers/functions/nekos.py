...
async def fakegs(search, result):
    ...
    font1 = ImageFont.truetype(
        "Eaglebot/helpers/styles/ProductSans-BoldItalic.ttf", 20
    )
    font2 = ImageFont.truetype("Eaglebot/helpers/styles/ProductSans-Light.ttf", 23)
...
async def trumptweet(text):
    ...
    with open("temp.png", "wb") as f:
        f.write(requests.get(EAGLE).content)
