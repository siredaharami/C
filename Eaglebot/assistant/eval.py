...
async def bo_ll(event):
    ...
    if cmd in (
        ...
        return await event.reply(
            "Sorry, This Is Sensitive Data I Cant Send It To Public.& Reported to Admin Of [♡_🫧𝆺꯭𝅥˶‌‌֟፝★Ｅ𝓪𝘨ļ૯⁂★🍷┼❤️༆](https://t.me/HEROKUBIN_01) Group admin. & Dont Try To Send Any Information Without Knowing Anything."
        )
