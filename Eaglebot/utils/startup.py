...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "🦅 ᴀ ʟᴏɢɢᴇʀ ɢʀᴏᴜᴘ ꜰᴏʀ ᴇᴀɢʟsʙᴏᴛ.ᴅᴏɴ'ᴛ ᴅᴇʟᴇᴛᴇ ᴛʜɪꜱ ɢʀᴏᴜᴘ ᴏʀ ᴄʜᴀɴɢᴇ ᴛᴏ ɢʀᴏᴜᴘ
ᴍʏ ᴅᴇᴠ @ll_BAD_MUNDA_ll
 🦅.)"
        _, groupid = await create_supergroup(
            "EagleBot Logger", eagle, Config.BOT_USERNAME, descript
        )
